...
| Quality Verification | Every code task has a quality verification step. Check: (1) All applicable tools from the Quality Tools section are listed. (2) No quality tool is missing for any file pattern touched. (3) Style exemplars are referenced and the conformance check is present. |
