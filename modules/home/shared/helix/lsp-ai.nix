...
in
{
  programs.helix.languages.language-server.ai = {
      ...
      actions = [
        {
          ...
          parameters = {
            ...
            max_tokens = 4096;
            system = ''
              You are an AI coding assistant specializing in code refactoring.

              Your task is to analyze the given code snippet and provide a refactored version. Follow these steps =
              ...
              6. Responses should use spaces for indentation.  If the language supports it, two spaces are preferrred.
  ...
  programs.helix.languages.language-server.ai-chat = {
    command = "${lib.getExe pkgs.lsp-ai}";
    config = {
      memory.file_store = { };
      models = {
      ...
      chat = [
        {
          ...
          parameters = {
            ...
            system = ''
              ...
              The user will ask you for assistance coding and you will do you
              best to answer succinctly and accurately.

              When replying prefix each response line with a comment to avoid breaking syntax highlighting.
            '';
          };
        }
      ];
